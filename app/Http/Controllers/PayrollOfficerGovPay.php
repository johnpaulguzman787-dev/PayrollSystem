...
class PayrollOfficerGovPay extends Controller
{
    public function index(Request $request)
    {
        ...
        $contributions = DB::table('payroll_records as pr')
            ...
            ->groupBy('pr.payroll_period_id','pp.name','pr.status')
            ->orderByDesc('pr.payroll_period_id')
            ->get();
        ...
        return view('payroll_officer.payroll-officer_govpay', compact('contributions', 'myContributions', 'years', 'year'));
    }
    ...
    public function view(Request $request, $periodId)
    {
        ...
        return view('payroll_officer.payroll-officer_govpay_views', compact('records', 'periodName', 'years', 'year'));
    }
}